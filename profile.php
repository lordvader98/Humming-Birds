...
<html lang="en" dir="ltr">
  <head>
    ...
    <style media="screen">
      .nav-row,.profile-content{display:flex}.profile-image{width:250px;height:250px}.profile-image>img{width:100%;height:100%}.nav-row{margin-top:10px}.nav-button{border-radius:3px;text-decoration:none}.nav-md{padding:6px 12px}.nav-sm{display:inline-block;padding:5px 10px}.impressions-container{margin-top:25px}.impressions-ul{margin-top:10px;padding:10px;border:1px solid #ddd;border-radius:5px}@media only screen and (min-width:801px){.profile-info{margin-left:15px}.edit-nav{margin-right:10px}}@media only screen and (max-width:800px){.profile-content{flex-direction:column}.profile-image{margin:auto;width:200px;height:200px}.profile-data{margin-top:10px;width:100%}.nav-row{justify-content:space-between}}@media only screen and (min-width:601px){.settings-icon{display:none}}@media only screen and (max-width:600px){.page-header{display:flex;justify-content:space-between;align-items:center}.profile-image{width:175px;height:175px}}
    </style>
  </head>
  <body>
