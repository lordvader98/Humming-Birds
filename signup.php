...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>New Registration | Sequelmark</title>
  ...
  <body>
    <main class="main-content">
      ...
      <form action="#" method="post" class="input-form">
        <ul class="form-ul">
          <li><h1>New Registration</h1></li>
          <li><input type="text" class="form-input" spellcheck="false" placeholder="Full name" autocomplete="off" required autofocus></li>
          <li><input type="tel" class="form-input" placeholder="Phone number" autocomplete="off" required></li>
          <li><input type="email" class="form-input" spellcheck="false" placeholder="Email address" autocomplete="off" required></li>
