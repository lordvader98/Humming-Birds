...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Recieved | Sequelmark</title>
      ...
      <div class="page-content">
        <header class="page-header">
          <ul class="tab-ul">
            ...
            <li><a href="recieved" class="active">Recieved</a></li>
          ...
          <ul class="data-ul">
            <li>
              <table class="y-table">
                ...
                <tr>
                  <td><a href="#" class="primary-button action-button">Accept</a></td>
                  <td><a href="#" class="neutral-button action-button">Decline</a></td>
                </tr>
              </table>
            </li>
            <li>
